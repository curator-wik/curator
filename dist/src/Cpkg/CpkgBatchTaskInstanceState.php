...
class CpkgBatchTaskInstanceState extends \Curator\Batch\TaskInstanceState  {
  ...
  public function __construct($service_name, $task_id, $num_runnables_estimate, $cpkg_path, $version) {
    parent::__construct($service_name, $task_id, $num_runnables_estimate);
